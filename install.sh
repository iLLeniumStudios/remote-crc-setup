...
echo "Console available here: https://console-openshift-console.apps.${BASE_DOMAIN}"
echo "Console Login Credentials: "
echo "USERNAME: ${USERNAME} PASSWORD: ${PASSWORD}"

echo ""

echo "CLI Login Command: oc login -u ${USERNAME} -p ${PASSWORD} https://api.${BASE_DOMAIN}:6443"
